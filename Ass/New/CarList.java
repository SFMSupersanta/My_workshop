...
public class CarList extends ArrayList<Car> {
    ...
    public void updateCar() {
        ...
        this.set(index, new Car(this.get(index).getCarID(), brandip.ref_getChoice(brandlist),
                ip.inputNonBlankStr("Enter color"), ip.inputPatten("Enter frame id (F0000)", "F[0-9]{5}"), engineID));
    }
    ...
    public boolean loadFromFile(String filename) {
        ...
        try {
            ...
            while ((buffer = br.readLine()) != null) {
                ...
                this.add(new Car(slice[0].strip(), brandlist.get(index), slice[2].strip(), slice[3].strip(),
                        slice[4].strip()));
            }
            br.close();
            fr.close();
    ...
    public void addCar() {
        ...
        this.add(new Car(ID, brandip.ref_getChoice(brandlist), ip.inputNonBlankStr("Enter color"),
                ip.inputPatten("Enter frame id (F0000)", "F[0-9]{5}"), engineID));
    }
    ...
    public void printBasedBrandName() {
        ...
        int i = 0;
        for (Car car : this) {
            if (car.getBrand().getBrandID().contains(search))
