...
public class StudentList {
    ...
    public void add() {
        ...
        Name = scan.nextLine(); // scan ten
        System.out.print("Enter Class: ");
        Class = scan.nextLine(); // scan lop
        System.out.print("Enter Score: ");
        Score = scan.nextDouble(); // scan diem
    ...
    public void delete() {
        ...
        do {
            ok = false;
            System.out.print("Enter RollNumber: ");
            RollNum = scan.nextLine(); // nhap so sv
            for (int i = 0; i < num; i++) {
            ...
            if (!ok)
                System.out.println(RollNum + ": does not exist"); // neu khong ton tai tiep tuc nhap
        } while (!ok);
