...
public class Main {
    public static void main(String args[])
    {
        ...
        DictionaryWord dictionary2 = new DictionaryWord("burglar","Breaks into a home to steal things",DictionaryWord.no);
        DictionaryWord dictionary3 = new DictionaryWord("forger","Makes an illegal copy of something",DictionaryWord.no);
        ...
        DictionaryWord dictionary6 = new DictionaryWord("mugger","Attacks and steals money from someone",DictionaryWord.no);
        DictionaryWord dictionary7 = new DictionaryWord("kidnapper","Holds someone for ransom money",DictionaryWord.no);
